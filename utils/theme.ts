...
const theme = {
  red: {
    ...
    icons: {
      ...
      borrowCardBg: require('../images/theme/icon/red/borrow_card_bg.png'),
  ...
  blue: {
    ...
    icons: {
      ...
      borrowCardBg: require('../images/theme/icon/blue/borrow_card_bg.png'),
  ...
  green: {
    ...
    icons: {
      ...
      borrowCardBg: require('../images/theme/icon/green/borrow_card_bg.png'),
  ...
  yellow: {
    ...
    icons: {
      ...
      borrowCardBg: require('../images/theme/icon/yellow/borrow_card_bg.png'),
